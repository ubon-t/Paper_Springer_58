...
%
<<<<<<< HEAD
Automobile License Plate Recognition (ALPR) becomes an important trend in Intelligent Transportation Systems (ITSs).
Because the license plate is a unique ID for a vehicle that can use to automatic recognition vehicles by reading license plates from photos or video recorded.
In addition, license plate recognition (LPR) has been widely applied in many uses.
...
The intelligentized traffic management and traffic safety enforcement also use LPR to implementing the processes.
...
license plate.
>>>>>>> 32168bbac0ea9db69acb9e5f2df7cbfd0641a7d9
