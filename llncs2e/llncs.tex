...
For the vehicle recognition method, there are several methods such as vehicle type recognition,  vehicle color recognition,  vehicle brand recognition, and vehicle model recognition to help facilitate the vehicle detection process \cite{kaza}, \cite{AshtariITS}, \cite{ShengITS}, \cite{Bailey}, \cite{AdorniLPR}, \cite{ZezhiChen}, \cite{Friedman}, \cite{Stauffer}, \cite{Hsieh}.
%5
...
In the next section, we discuss background information and previous studies
...
Although the above proposals are useful for vehicle detection to detect the suspect vehicle, we focus on the detection of suspect vehicles with forged license plate. 
...
Figure \ref{fig:diagram} shows the research design and the evolution process of criminal or suspect vehicle detection at the checkpoint. This diagram is divided into three sections: 
